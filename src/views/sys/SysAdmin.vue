...
export default {
  ...
  methods: {
    ...
    initAllRoles() {
      this.getRequest("/system/admin/getAllRole").then(resp => {
        if (resp) {
          this.allRoles = resp;
        }
      });
    ...
    enabledChange(admin) {
      // debugger
      this.tAdmin.id = admin.id;
      this.tAdmin.enabled = admin.enabled;
      this.putRequest("/system/admin/updateAdmin",this.tAdmin).then(resp => {
        if (resp) {
          this.initAdmins();
        }
      });
    ...
    initAdmins() {
      this.getRequest("/system/admin/getAllAdmin/?keyWord=" + this.keywords).then(resp => {
        if (resp) {
          this.admins = resp;
        }
      });
