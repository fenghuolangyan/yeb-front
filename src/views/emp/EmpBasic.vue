  ...
  <div>
      ...
      <div style="display: flex;justify-content: space-between">
        <div>
          ...
          <el-button type="primary" @click="showAdvanceSearchVisible = !showAdvanceSearchVisible">
            <i
              :class="showAdvanceSearchVisible?'fa fa-angle-double-up':'fa fa-angle-double-down'"
              aria-hidden="true"
            ></i>
            高级搜索
          </el-button>
    ...
    <div style="margin-top: 10px">
      ...
      >
        ...
        <el-table-column prop="address" label="联系地址" align="left" width="270"></el-table-column>
        <el-table-column prop="department.name" label="所属部门" align="left" width="100"></el-table-column>
        ...
        <el-table-column prop="school" label="毕业院校" align="left" width="150"></el-table-column>
      ...
      <div style="display: flex;justify-content: flex-end">
        <el-pagination
          ...
          :page-sizes="[size,10, 20, 30, 50,100]"
          :page-size="size"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        birthday: [
          { required: true, message: "请输入生出日期", trigger: "blur" }
        ],
        idCard: [
  ...
  methods: {
    ...
    exportData() {
      this.downloadRequest("/employee/basic/exportEmployee");
    },
    ...
    initPositions() {
      this.getRequest("/employee/basic/getPositions").then(resp => {
        if (resp) {
          this.positions = resp;
        }
      });
    ...
    initData() {
      if (!window.sessionStorage.getItem("nations")) {
        this.getRequest("/employee/basic/getNations").then(resp => {
          if (resp) {
            this.nations = resp;
      ...
      if (!window.sessionStorage.getItem("joblevels")) {
        this.getRequest("/employee/basic/getJoblevels").then(resp => {
          if (resp) {
            this.joblevels = resp;
      ...
      if (!window.sessionStorage.getItem("politicsstatus")) {
        this.getRequest("/employee/basic/getPoliticsstatus").then(resp => {
          if (resp) {
      ...
      if (!window.sessionStorage.getItem("allDeps")) {
        this.getRequest("/employee/basic/getDeps").then(resp => {
          if (resp) {
            this.allDeps = resp;
    ...
    initEmps(type) {
      this.loading = true;
      let url =
        "/employee/basic/getLimitEmployee?currentPage=" +
        this.currentPage +
        "&size=" +
        this.size;
